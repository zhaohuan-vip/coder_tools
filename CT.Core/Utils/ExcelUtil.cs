...
namespace HIHS.Core.Utils
{
    public static class ExcelUtil
    {
        ...
        static void ExportDTI(DataTable dtSource, string strHeaderText, FileStream fs)
        {
            ...
            foreach (DataRow row in dtSource.Rows)
            {
                ...
                foreach (DataColumn column in dtSource.Columns)
                {
                    ...
                    XSSFCellStyle fCellStyle = workbook.CreateCellStyle() as XSSFCellStyle;
                    string drValue = row[column].ToString();
                    ...
                    if (drValue == "可定")
                    {
                        ...
                        XSSFFont font1 = workbook.CreateFont() as XSSFFont;
                        //红色
        ...
        /// <summary>
        /// DataTable导出到Excel的MemoryStream 下载协议模板使用
        /// </summary>
        /// <param name="dtSource">源DataTable</param>
        /// <param name="strHeaderText">表头文本</param>
        static void ExportDTI1(DataTable dtSource, string strHeaderText, FileStream fs)
        {
            XSSFWorkbook workbook = new XSSFWorkbook();
            XSSFSheet sheet = workbook.CreateSheet() as XSSFSheet;
            XSSFCellStyle dateStyle = workbook.CreateCellStyle() as XSSFCellStyle;
            ...
            if (!string.IsNullOrEmpty(strHeaderText))
            {
                ...
                CellRangeAddress rangeAddress = new CellRangeAddress(0, 0, 0, dtSource.Columns.Count);
                //添加要合并地址到表格
        ...
        /// <param name="strHeaderText">表头文本</param>
        public static void ExportDTtoExcel(DataTable dtSource, string strFileName, string strHeaderText = "")
        {
        ...
        /// <summary>
        /// DataTable导出到Excel文件，下载协议模板使用
        /// </summary>
        /// <param name="dtSource">源DataTable</param>
        /// <param name="strFileName">保存位置</param>
        /// <param name="strHeaderText">表头文本</param>
        public static void ExportDTtoExcel1(DataTable dtSource, string strFileName, string strHeaderText = "")
        {
            string[] temp = strFileName.Split('.');
            ...
            else
            {
                ...
                using (FileStream fs = new FileStream(strFileName, FileMode.Create, FileAccess.Write))
                {
                    ExportDTI1(dtSource, strHeaderText, fs);
                }
            }
        }
        #endregion
